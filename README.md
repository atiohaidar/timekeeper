...
<!-- ================= BLOK PENULIS (GRID 2 KOLOM) ================= -->
<div class="ieee-authors-grid">
  <!-- Penulis 1 -->
  <div class="ieee-author">
    <div class="ieee-author-name"><b>Atio Haidar</b></div>
  ...
  <!-- Penulis 2 -->
  <div class="ieee-author">
    <div class="ieee-author-name"><b>Antigravity AI</b></div>
    <div class="ieee-author-aff">
      Advanced AI Pair Programmer<br>
      Google DeepMind AI Team<br>
      [City, Country]<br>
      [Author Email]
    </div>
  </div>
